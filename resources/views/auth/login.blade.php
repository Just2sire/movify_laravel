...
{{-- {{ route('image.upload') }} --}}
                            <!-- Start of Login form -->
                            <form id="cariera_login" action="{{ route('login') }}" method="post">
                                @csrf
                                {{-- <p class="status"></p> --}}

                                {{-- <div class="form-group">
                                    <input type="file" class="img-fluid img-thumbnail rounded" name="image">
                                </div> --}}

                                <div class="form-group">
                                    <label for="username">{{ __('Adresse Mail') }}</label>
                            ...
                            <div class="bottom-links">
                                <span>
                                    Pas de compte?
                                    <a  class="" href="register">S'inscrire</a>
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="forgetpassword-wrapper">
                        ...
                        <div class="small-dialog-content">
                            ...
                            <form id="forget_pass_form" action="#"  method="post">
                                ...
                                <div class="form-group">
                                    <label for="password">Addresse Mail</label>
